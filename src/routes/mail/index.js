...
router.post("/gmail-send", async (req, res) => {
  ...
  console.log("credentials.client_id", process.env.CLIENT_ID)
  console.log("credentials.client_id", process.env.CLIENT_SECRET)
  console.log("credentials.client_id", process.env.REDIRECT_URL)
